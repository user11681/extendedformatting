...
public interface TextFormatter {
     ...
     */
    void format(TextRendererDrawerAccess drawer, Style style, int charIndex, int character, FontStorage storage, Glyph glyph, GlyphRenderer glyphRenderer, float red, float green, float blue, float alpha, float advance);
}
